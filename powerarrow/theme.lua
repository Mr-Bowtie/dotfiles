...
theme.wallpaper                                 = theme.dir .. "/fantasy-city.png"
theme.font                                      = "JetBrainsMonoMedium Nerd Font 9"
...
theme.cal = lain.widget.cal({
    ...
    attach_to = { binclock.widget }, --todo
    notification_preset = {
        font = "Terminus 10",
        fg   = theme.fg_normal,
        bg   = theme.bg_normal
...
theme.volume = lain.widget.pulse {
    settings = function()
        ...
        widget:set_markup(lain.util.markup.font(theme.font, vlevel))
    end
}
--[[ MPD
...
function theme.at_screen_connect(s)
    ...
    -- 
    tags = {
      { "Terminal", "Browser", "Steam", "Notion", "Discord", "bpytop"},
      { "Terminal", "Browser", "Steam", "Notion", "Thunderbird", "Spotify"},
      { "Terminal", "Browser", "Steam", "Notion", "Spotify", "bpytop"},
    }
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            -- using separators
            arrow_left(theme.bg_normal, theme.bg_normal),
            arrow_left(theme.bg_normal, "#419DC4"),
            wibox.container.background(wibox.container.margin(wibox.widget { volumeicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#419DC4"),
            arrow_left("#419DC4", "#C46B41"),
            -- wibox.container.background(wibox.container.margin(task, dpi(3), dpi(7)), "#343434"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#C46B41"),
            arrow_left("#C46B41", "#C4AC41"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#C4AC41"),
            arrow_left("#C4AC41", "#C46b41"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#C46b41"),
            arrow_left("#C46b41", "#419DC4"),
            wibox.container.background(wibox.container.margin(wibox.widget.textclock()), "#419DC4"),
            s.mylayoutbox,
            --[[ using shapes
